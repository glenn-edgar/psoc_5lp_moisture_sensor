...
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",9)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",10)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",11)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",12)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",13)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",14)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
hf.send_event("CF_MEASURE_MOISTURE_CHANNEL",15)
hf.wait_event_count("CF_MOISTURE_CHANNEL_DONE",2)
