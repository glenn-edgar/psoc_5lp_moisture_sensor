// ======================================================================
// Pin_System_Definition.v generated from TopDesign.cysch
// 09/23/2016 at 18:59
...
// IDAC8_v2_0(Current=100, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=0, Initial_Value=120, Polarity=4, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_1, CY_INSTANCE_SHORT_NAME=IDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=IDAC8_1, )
module IDAC8_v2_0_3 (
    iOut,
    data,
    strobe,
...
module top ;
    ...
    defparam AMux_1.muxin_width = 9;
    defparam AMux_1.init_mux_sel = 9'h0;
    ...
    defparam AMux_2.muxin_width = 9;
    defparam AMux_2.init_mux_sel = 9'h0;
    defparam AMux_2.one_active = 1;
    defparam AMux_2.connect_mode = 2;
    
    // -- AMux AMux_2 end --

	wire [8:0] tmpOE__Moisture_sensor_1_pins_net;
	wire [8:0] tmpFB_8__Moisture_sensor_1_pins_net;
	wire [8:0] tmpIO_8__Moisture_sensor_1_pins_net;
	wire [0:0] tmpINTERRUPT_0__Moisture_sensor_1_pins_net;
	electrical [0:0] tmpSIOVREF__Moisture_sensor_1_pins_net;
	...
	cy_psoc3_pins_v1_10
		...
		Moisture_sensor_1_pins
		 (.oe(tmpOE__Moisture_sensor_1_pins_net),
		  .y({9'b0}),
		  .fb({tmpFB_8__Moisture_sensor_1_pins_net[8:0]}),
		  .analog({Net_8026, Net_7952, Net_7962, Net_7963, Net_7964, Net_7965, Net_7966, Net_7967, Net_7968}),
		  .io({tmpIO_8__Moisture_sensor_1_pins_net[8:0]}),
		  .siovref(tmpSIOVREF__Moisture_sensor_1_pins_net),
		  .interrupt({tmpINTERRUPT_0__Moisture_sensor_1_pins_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Moisture_sensor_1_pins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{9'b111111111} : {9'b111111111};

	wire [8:0] tmpOE__Moisture_Sensor_Pin_2_net;
	wire [8:0] tmpFB_8__Moisture_Sensor_Pin_2_net;
	wire [8:0] tmpIO_8__Moisture_Sensor_Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Moisture_Sensor_Pin_2_net;
	electrical [0:0] tmpSIOVREF__Moisture_Sensor_Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("967f7031-db72-496a-8b58-b020792c8532"),
		  .drive_mode(27'b000_000_000_000_000_000_000_000_000),
		  .ibuf_enabled(9'b0_0_0_0_0_0_0_0_0),
		  .init_dr_st(9'b0_0_0_0_0_0_0_0_0),
		  .input_clk_en(0),
		...
		Moisture_Sensor_Pin_2
		 (.oe(tmpOE__Moisture_Sensor_Pin_2_net),
		  .y({9'b0}),
		  .fb({tmpFB_8__Moisture_Sensor_Pin_2_net[8:0]}),
		  .analog({Net_7957, Net_7956, Net_7979, Net_7978, Net_7976, Net_7974, Net_7971, Net_8027, Net_7969}),
		  .io({tmpIO_8__Moisture_Sensor_Pin_2_net[8:0]}),
		  .siovref(tmpSIOVREF__Moisture_Sensor_Pin_2_net),
		  .interrupt({tmpINTERRUPT_0__Moisture_Sensor_Pin_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Moisture_Sensor_Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{9'b111111111} : {9'b111111111};
    ...
    ADC_SAR_SEQ_v2_0_7 ADC_SAR_Seq_1 (
        .soc(1'b0),
        .aclk(1'b0),
        .sdone(Net_6098),
        .eoc(Net_6099),
