...
uint16 const logging_flag        = 0;
uint16 const sampling_interval   = 2;  // for production use 60 or 1 hour
...
void initialize_modbus_registers( void )
{
    ...
    store_modbus_data_registers( LOGGING_FLAG , 1,(uint16 *) &logging_flag );
    temp = 0;
